...
'''
Team Members: Sher Sanginov, Daryl Sullivan, Jonathan Chauwa, Andrew Mambondiumwe, Jose Lindia

What is included?
*We added checksum to this protocol. We added checksum in the get_message method in both client and server.
...
to the destination of the corrupted message. For the checksum part, we used the checksum algorithm which we implemented in class homework.
assignment.
...
*We made this program very user-interactive.
*The Mail Server protocol is multi-threaded. We used threading library to accomplish that.
